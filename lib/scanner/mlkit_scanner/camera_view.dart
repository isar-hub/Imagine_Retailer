...
class _CameraViewState extends State<CameraView>implements onDetectedListener  {
  ...
  void didUpdateWidget(CameraView oldWidget) {
    ...
    if (oldWidget.isDetected != widget.isDetected) {
      if (widget.isDetected) {
        _stopLiveFeed();
      } else {
        // If isDetected changes from true to false, reinitialize the camera feed
        _startLiveFeed(); // Call your method to start the camera feed again
      }
    }
  }
...
abstract class onDetectedListener {
  void onDetected();
  }
